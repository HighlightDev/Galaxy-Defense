...
public:
    ...
    GetSpaceshipMaterial(const std::shared_ptr<::EngineCore::Scene>& scene, bool& alreadyExists) const;

    std::shared_ptr<::Graphics::IMaterial>
    GetEngineMaterial(const std::shared_ptr<::EngineCore::Scene>& scene, bool& alreadyExists) const;
};
} // namespace Game