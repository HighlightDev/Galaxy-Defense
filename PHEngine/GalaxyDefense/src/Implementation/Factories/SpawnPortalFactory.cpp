...
namespace Game
{
    ...
    SpawnPortalFactory::CreatePortal(const std::shared_ptr<::EngineCore::Scene> &scene,
                                     ...
                                     const float billboardSize)
    {
        ...
        const auto &rootComponent = std::make_shared<EngineCore::SceneComponent>("c_portal_root_" + portalIndexStr,
