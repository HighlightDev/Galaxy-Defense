...
{
    const uint32_t health = static_cast<uint32_t>(Random::Float() * 10) + 30;
    ...
    const auto d_particle = std::make_shared<ParticleSystemComponentData>(
        "c_particleSystemComponent_fighter_" + fighterShipIndexStr, particles_mat, glm::vec3(0), glm::vec3(1.0f), 500, false);
