...
namespace Game
{
    ...
    {
        const size_t curvePathPointsCount = mSubdivisionsCount <= static_cast<size_t>(1) ? static_cast<size_t>(2) : static_cast<size_t>(mSubdivisionsCount + 1);
        ...
        for (size_t i = 1; i < (curvePathPointsCount); ++i)
        {
            ...
            mTotalSegmentPoints.emplace_back(EngineMath::QuadraticBezier(mQuadraticBezierControlPoints.at(0),
