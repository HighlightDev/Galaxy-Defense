...
namespace Game
{
   ...
   class LuaLvlProgressFunctions
       : public ILuaFunctionable,
         public std::enable_shared_from_this<LuaLvlProgressFunctions>
   {
   protected:
   ...
   public:
      LuaLvlProgressFunctions(::EngineCore::Scripts::LuaScriptExecutorBase *ownerPtr,
