...
namespace Game
{
    ...
    {
        SetMissedSpaceshipsCount(LevelDataProvider::GetInstance()->GetCurrentStageSurvivedEnemySpaceshipsCount() - mInitialMissedSpaceshipsCount);
    }
