...
namespace Game
{
                                               ...
                                               const glm::vec3 &scale)
  {
    ...
    const auto d_mesh = std::make_shared<MeshComponentData>("c_barrier_mesh_barrier_" + barrierIndexStr + "_pillar_" + std::to_string(pillarsSize),
                                                            "ufo.obj", position, glm::vec3(), glm::vec3(6.0, 12.0, 6.0), "", barrier_mat.first);
    ...
    a_barrier->TrySetBarrierPillarMeshRelativeTransform(pillarsSize, position, glm::vec3(), glm::vec3(6.0, 12.0, 6.0));
  }
