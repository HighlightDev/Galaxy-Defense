...
namespace Game
{
    ...
    glm::vec3 SmartPicker::CreateWorldSpaceRayFromScreenSpacePosition(const std::shared_ptr<ACamera> &camera,
                                                                      const glm::ivec2 &screenSpacePosition) const
    {
        ...
        return screenRayCaster.CastRayFromScreenSpaceToWorldSpace(screenSpacePosition,
                                                                  glm::ivec2(displayDataProvider->GetWindowWidth() - 1,
                                                                             displayDataProvider->GetWindowHeight() - 1),
