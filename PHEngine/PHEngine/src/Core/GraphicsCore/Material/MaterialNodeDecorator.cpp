...
namespace Graphics
{
   ...
   std::shared_ptr<MaterialNode> MaterialNodeDecorator::CreateValueNode(const std::string &propertyName,
   ...
   std::shared_ptr<MaterialNode> MaterialNodeDecorator::CreateMaterialOperationNode(std::string const &nodeName,
   ...
   XMLParserHelper::iterator_t MaterialNodeDecorator::GetTagWithName(const std::string &operationName,
