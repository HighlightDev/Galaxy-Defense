...
namespace Graphics {
MaterialBinaryDivOperationNode::MaterialBinaryDivOperationNode(const MaterialNode::eMaterialPropertyType materialPropertyType)
...
std::any MaterialBinaryDivOperationNode::DoOperation(const std::any& left, const std::any& right)
{
