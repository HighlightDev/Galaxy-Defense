...
struct CompositeMaterialShaderParams : public CompositeShaderParams {

    std::shared_ptr<MaterialProxy> mMaterialProxy;

    CompositeMaterialShaderParams(
        const std::string& shaderName, const ShaderParams& shaderParams, std::shared_ptr<MaterialProxy> materialProxy)
