...
ShaderGenericConstantArray::ShaderGenericConstantArray(
    const std::string& name, const std::string& innerTypeName, const std::string& value)
    : m_Name(name)
...
ShaderConstantArray::ShaderConstantArray(
