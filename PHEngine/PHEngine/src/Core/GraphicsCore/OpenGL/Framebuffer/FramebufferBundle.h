...
public:
    ...
    virtual void CopyFramebufferDataToDefaultFramebuffer(
        const size_t srcX,
        const size_t srcY,
    ...
    virtual void CopyFramebufferDataToDstFramebuffer(
...
protected:
    ...
    void
    RenderToFBO(const FramebufferObject& fbo, bool bBindFramebuffer, const ViewPortInfo& viewport, GLbitfield clearFlag) const;
    void FramebufferClear(const FramebufferObject& fbo, const GLbitfield clearFlag);

    void CopySrcFramebufferDataToDefaultFramebufferImpl(
    ...
    void CopySrcFramebufferDataToDstFramebufferImpl(
        const std::shared_ptr<IFramebufferObject>& srcFbo,
...
private:
    void
    SetupViewport(size_t viewportX, size_t viewportY, size_t viewportWidth, size_t viewportHeight, GLbitfield clearFlag) const;
};
