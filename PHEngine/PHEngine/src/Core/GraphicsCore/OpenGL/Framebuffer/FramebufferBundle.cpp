...
namespace Graphics
{
   ...
   void FramebufferBundle::CopyFramebufferDataToDefaultFramebuffer(const size_t srcX, const size_t srcY, const size_t srcResolutionX, const size_t srcResolutionY,
                                                                   const size_t dstX, const size_t dstY, const size_t dstResolutionX, const size_t dstResolutionY,
                                                                   const int32_t bufferBit)
   {
   }

   void FramebufferBundle::CopyFramebufferDataToDstFramebuffer(const std::shared_ptr<IFramebufferObject> &dstFramebuffer,
   ...
   void FramebufferBundle::CopySrcFramebufferDataToDefaultFramebufferImpl(const std::shared_ptr<IFramebufferObject> &srcFbo,
                                                                          const size_t srcX, const size_t srcY, const size_t srcResolutionX, const size_t srcResolutionY,
                                                                          const size_t dstX, const size_t dstY, const size_t dstResolutionX, const size_t dstResolutionY,
                                                                          const int32_t bufferBit)
   {
   ...
   void FramebufferBundle::CopySrcFramebufferDataToDstFramebufferImpl(const std::shared_ptr<IFramebufferObject> &srcFbo,
