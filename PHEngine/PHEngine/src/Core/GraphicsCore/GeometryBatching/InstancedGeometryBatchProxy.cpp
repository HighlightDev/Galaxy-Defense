...
namespace Graphics::GeometryBatching
{
    ...
    void InstancedGeometryBatchProxy::Initialize()
    {
        ...
        mShader = std::static_pointer_cast<typename InstancedGeometryBatchProxy::ShaderType>(PrimitiveSceneProxy::CreateMaterialShader<InstancedStaticMeshVertexFactory,
    ...
    void InstancedGeometryBatchProxy::Render(const std::shared_ptr<CameraSceneProxy> &cameraSceneProxy,
    ...
    void InstancedGeometryBatchProxy::AddInstancedStaticMeshSceneProxy(const std::shared_ptr<::Graphics::Proxy::InstancedStaticMeshSceneProxy> &sceneProxy)
    {
    ...
    void InstancedGeometryBatchProxy::RemoveInstancedStaticMeshSceneProxy(const std::shared_ptr<::Graphics::Proxy::InstancedStaticMeshSceneProxy> &sceneProxy)
    {
    ...
    void InstancedGeometryBatchProxy::PrepareRenderData()
    {
        ...
        {
            const auto foundIt = std::find_if(mInstancedStaticMeshSceneProxies.cbegin(), mInstancedStaticMeshSceneProxies.cend(), [sceneProxyId](const auto& proxyWp) {
                 if (const auto &proxySp = proxyWp.lock())
                 {
