...
ProjectedDirectionalLightShadowInfo::ProjectedDirectionalLightShadowInfo(
    const TextureAtlasSpaceRequest& shadowmapAtlasRequest, const float shadowOrthoHalfExtent)
...
void ProjectedDirectionalLightShadowInfo::Initialize()
{
    Event::TextureAtlasGeneratedGameThreadEvent::GetInstance()->AddListener(
        std::dynamic_pointer_cast<ProjectedDirectionalLightShadowInfo>(shared_from_this()));
}
...
void ProjectedDirectionalLightShadowInfo::ProcessEvent(
