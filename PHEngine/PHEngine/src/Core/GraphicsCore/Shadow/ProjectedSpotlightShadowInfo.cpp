...
namespace Graphics
{
   ...
   {
      Event::TextureAtlasGeneratedGameThreadEvent::GetInstance()->AddListener(std::dynamic_pointer_cast<ProjectedSpotlightShadowInfo>(shared_from_this()));
   }
   ...
   void ProjectedSpotlightShadowInfo::ProcessEvent(const TextureAtlasGeneratedGameThreadEvent* sender, const typename Event::TextureAtlasGeneratedGameThreadEvent::EventData_t &data)
   {
