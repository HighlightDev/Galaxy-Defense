...
glm::vec3 ScreenRayCaster::CastRayFromScreenSpaceToWorldSpace(
...
glm::vec2
ScreenRayCaster::GetNormalizedScreenSpacePosition(const glm::ivec2& screenSpacePosition, const glm::ivec2& windowSize) const
{
    return glm::vec2(
        static_cast<float>(screenSpacePosition.x) / static_cast<float>(windowSize.x),
