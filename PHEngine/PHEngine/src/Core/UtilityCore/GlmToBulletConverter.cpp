...
bool isEqual(const btTransform& left, const btTransform& right)
{
    ...
    return (
        FloatsNearEqual(originL.getX(), originR.getX()) && FloatsNearEqual(originL.getY(), originR.getY())
        && FloatsNearEqual(originL.getZ(), originR.getZ()) && FloatsNearEqual(basisL.getX(), basisR.getX())
        && FloatsNearEqual(basisL.getY(), basisR.getY()) && FloatsNearEqual(basisL.getZ(), basisR.getZ())
