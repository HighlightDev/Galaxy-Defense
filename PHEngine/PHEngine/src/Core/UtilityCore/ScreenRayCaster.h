...
public:
    glm::vec3 CastRayFromScreenSpaceToWorldSpace(
...
private:
    glm::vec2 GetNormalizedScreenSpacePosition(const glm::ivec2& screenSpacePosition, const glm::ivec2& windowSize) const;
