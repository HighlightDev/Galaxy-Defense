...
namespace EngineCore
{
   ...
   public:
      ...
      void AccessAllUniformLocations(uint32_t shaderProgramID) override
      {
         ...
         u_worldMatrices = GetUniformArray("worldMatrices", cfg.MaxStaticMeshInstancesPerBatch, shaderProgramID, eShaderType::VertexShader);
      ...
      {
         const auto &cfg = EngineConfigHolder::GetInstance()->GetEngineConfig();
         DefineConstant<int32_t>("MAX_STATIC_MESH_INSTANCES_PER_BATCH",
                                 cfg.MaxStaticMeshInstancesPerBatch);
      }
