...
{
    mExtractBrightPartsSubroutineIndex
        = GetSubroutineIndex(MapShaderTypeToOpenGLConstant(eShaderType::FragmentShader), "extractBrightParts");
    mVerticalBlurSubroutineIndex
