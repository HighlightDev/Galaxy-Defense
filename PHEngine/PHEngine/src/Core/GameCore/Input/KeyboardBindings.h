...
enum class eKeyActionType { NONE, ACTION_MOVE_FORWARD, ACTION_MOVE_LEFT, ACTION_MOVE_RIGHT, ACTION_MOVE_BACK, ACTION_JUMP };
...
class KeyboardBindings : public KeyboardButtonDownGameThreadEvent, public std::enable_shared_from_this<KeyboardBindings> {
...
public:
    ...
    void ProcessEvent(
        const KeyboardButtonDownGameThreadEvent* sender,
        const typename KeyboardButtonDownGameThreadEvent::EventData_t& data) override;
