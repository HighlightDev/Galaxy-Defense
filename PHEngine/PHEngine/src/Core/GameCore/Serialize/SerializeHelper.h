...
public:
    ...
    static std::shared_ptr<SerializeDataPlanarReflectionComponent>
    GetSerializedDataPlanarReflectionComponent(const std::shared_ptr<PlanarReflectionComponent>& component);
    ...
    static std::shared_ptr<SerializeDataPhysicsShape>
    GetSerializePhysicsShapeData(const std::shared_ptr<CollisionShapeBase>& physicsShape);

    static std::shared_ptr<ACamera> CreateCameraFromSerializedData(
    ...
    CreateComponentFromSerializedData(std::shared_ptr<Scene> scene, std::shared_ptr<SerializeDataBase> data);
