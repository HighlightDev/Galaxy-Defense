...
namespace EngineCore
{
   ...
   void LuaCommonEngineFunctions::RegisterCallbacks()
   {
      ...
      LuaRegisterCallbackTest<LuaExecutor_t, 0, GameObject *(std::string)>::Register(mLuaInstance, "_GetGameObject");
      LuaRegisterCallbackTest<LuaExecutor_t, 1, float(GameObject *, std::string)>::Register(mLuaInstance, "_GetGOPropertyValFloat");
      LuaRegisterCallbackTest<LuaExecutor_t, 2, int32_t(GameObject *, std::string)>::Register(mLuaInstance, "_GetGOPropertyValInteger");
      LuaRegisterCallbackTest<LuaExecutor_t, 3, void(GameObject *, std::string, glm::vec3)>::Register(mLuaInstance, "_SetGOPropertyValVec3");
      LuaRegisterCallbackTest<LuaExecutor_t, 4, void(GameObject *, std::string, int32_t)>::Register(mLuaInstance, "_SetGOPropertyValBool");
      LuaRegisterCallbackTest<LuaExecutor_t, 5, int32_t(void)>::Register(mLuaInstance, "_GetWindowHeight");
      LuaRegisterCallbackTest<LuaExecutor_t, 6, int32_t(void)>::Register(mLuaInstance, "_GetWindowWidth");
   }
