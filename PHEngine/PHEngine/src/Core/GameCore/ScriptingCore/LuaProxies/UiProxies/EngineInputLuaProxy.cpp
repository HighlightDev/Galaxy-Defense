...
void EngineInputLuaProxy::ProcessEvent(
    const KeyboardButtonDownLuaThreadEvent* sender, const typename KeyboardButtonDownLuaThreadEvent::EventData_t& data)
{
...
void EngineInputLuaProxy::ProcessEvent(
    const MouseScrollLuaThreadEvent* sender, const typename MouseScrollLuaThreadEvent::EventData_t& data)
{
    // todo: to be implemented later
}

void EngineInputLuaProxy::ProcessEvent(
    const MouseButtonDownLuaThreadEvent* sender, const typename MouseButtonDownLuaThreadEvent::EventData_t& data)
{
    // todo: to be implemented later
}
