...
namespace EngineCore
{
   namespace Scripts
   {
      ...
      void LuaEngineObjectsCreatorFunctions::SetScene(const std::weak_ptr<Scene> &sceneWp)
      {
         ...
         mEngineObjectCreator->RegisterComponentCreatorFactory("DefaultComponentCreatorFactory", std::make_shared<DefaultComponentCreatorFactory>());
      }
      ...
      void LuaEngineObjectsCreatorFunctions::RegisterCallbacks(const LuaWrapper &luaWrapper)
      {
         ...
         LuaCallbackBindingHelper<Hash64_CT("LuaEngineObjectsCreatorFunctions::SetFloatToMaterial"), void(int32_t, float, std::string)>::Bind(luaWrapper, mOwnerPtr, std::bind(&LuaEngineObjectsCreatorFunctions::SetFloatToMaterial, this, std::placeholders::_1), "_SetFloatToMaterial");
         LuaCallbackBindingHelper<Hash64_CT("LuaEngineObjectsCreatorFunctions::SetDeferredTextureToMaterial"), void(int32_t, std::string, std::string)>::Bind(luaWrapper, mOwnerPtr, std::bind(&LuaEngineObjectsCreatorFunctions::SetDeferredTextureToMaterial, this, std::placeholders::_1), "_SetDeferredTextureToMaterial");
         LuaCallbackBindingHelper<Hash64_CT("LuaEngineObjectsCreatorFunctions::SetBindingToMaterial"), void(int32_t, std::string, std::string, std::string)>::Bind(luaWrapper, mOwnerPtr, std::bind(&LuaEngineObjectsCreatorFunctions::SetBindingToMaterial, this, std::placeholders::_1), "_SetBindingToMaterial");

         LuaCallbackBindingHelper<Hash64_CT("LuaEngineObjectsCreatorFunctions::CreateTweener"), int32_t(int32_t, std::string)>::Bind(luaWrapper, mOwnerPtr, std::bind(&LuaEngineObjectsCreatorFunctions::CreateTweener, this, std::placeholders::_1), "_CreateTweener");
         LuaCallbackBindingHelper<Hash64_CT("LuaEngineObjectsCreatorFunctions::SetTweenerBinding"), void(int32_t, int32_t, std::string, std::string, std::string)>::Bind(luaWrapper, mOwnerPtr, std::bind(&LuaEngineObjectsCreatorFunctions::SetTweenerBinding, this, std::placeholders::_1), "_SetTweenerBinding");
      }
      ...
      /* -------------------  Create Actor ----------------------------*/
      int32_t LuaEngineObjectsCreatorFunctions::CreateActor(const std::tuple<std::string /*Actor type*/,
                                                                             ...
                                                                             std::string /*json params string*/> &actorData)
      {
         ...
         return mEngineObjectCreator->CreateActor(actorTypeName, actorName, rootComponentTranslation, rootComponentRotation, rootComponentScale, jsonParamsString);
      }

      /* -------------------  Create component and attach to actor ----------------------------*/
      void LuaEngineObjectsCreatorFunctions::CreateAndAttachComponentToActor(const std::tuple<int32_t /*actorObjectId*/,
      ...
      /* -------------------  Set texture --------------------*/
      void LuaEngineObjectsCreatorFunctions::SetTextureToMaterial(const std::tuple<int32_t /*material proxy id*/, std::string, std::string> &setTextureToMaterial)
      {
      ...
      void LuaEngineObjectsCreatorFunctions::SetDeferredTextureToMaterial(const std::tuple<int32_t /*material proxy id*/,
      ...
      /* -------------------  Set float --------------------*/
      void LuaEngineObjectsCreatorFunctions::SetFloatToMaterial(const std::tuple<int32_t /*material proxy id*/, float, std::string> &setFloatValueToMaterial)
      {
      ...
      void LuaEngineObjectsCreatorFunctions::SetBindingToMaterial(const std::tuple<int32_t /*material proxy id*/, std::string, std::string, std::string> &setBindingToMaterial)
      {
      ...
      /* -------------------  Create Tweener ----------------------------*/
      int32_t LuaEngineObjectsCreatorFunctions::CreateTweener(const std::tuple<int32_t /*Actor id*/, std::string /*tweener name*/> &tweenerData)
      {
      ...
      void LuaEngineObjectsCreatorFunctions::SetTweenerBinding(const std::tuple<int32_t /*Actor id which holds tweener*/,
                                                                                int32_t /*tweener id*/,
