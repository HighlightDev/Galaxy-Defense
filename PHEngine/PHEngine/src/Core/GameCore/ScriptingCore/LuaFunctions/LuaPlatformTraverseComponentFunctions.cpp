...
namespace EngineCore
{
   namespace Scripts
   {
      LuaPlatformTraverseComponentFunctions::LuaPlatformTraverseComponentFunctions(PlatformTraverseComponent *owner,
                                                                                   LuaScriptExecutorBase *ownerPtr)
          : mOwnerPtr(ownerPtr),
      ...
      {
         LuaCallbackBindingHelper<Hash64_CT("LuaPlatformTraverseComponentFunctions::AddRoutePoint"), void(std::string, glm::vec3, glm::vec3, glm::vec3, float)>::Bind(luaWrapper, mOwnerPtr, std::bind(&LuaPlatformTraverseComponentFunctions::AddRoutePoint, this, std::placeholders::_1), "_AddRoutePoint");
      }
