...
void ActorController::Tick(const float deltaTimeSec, const float playSpeed)
{
}

void ActorController::UnpausableTick(const float deltaTimeSec, const float playSpeed)
{
}
