...
{
    TexParams reflectionTexParams(
        mReflectionViewPortInfo.Width - mReflectionViewPortInfo.OriginX,
        mReflectionViewPortInfo.Height - mReflectionViewPortInfo.OriginY,
        GL_TEXTURE_2D,
        GL_NEAREST,
        GL_LINEAR,
        0,
    ...
    TexParams reflectionSurfaceParams(
        mReflectionViewPortInfo.Width - mReflectionViewPortInfo.OriginX,
        mReflectionViewPortInfo.Height - mReflectionViewPortInfo.OriginY,
        GL_TEXTURE_2D,
        GL_NEAREST,
