...
namespace EnginePhysics
{
   ...
   void CollisionCompoundShape::AddChildShape(const NoScaleEulerRotationTransform &childTransform, const std::shared_ptr<CollisionShapeBase> &childShape)
   {
   ...
   const std::vector<std::pair<std::shared_ptr<CollisionShapeBase>, NoScaleEulerRotationTransform>> &CollisionCompoundShape::GetChildShapes() const
   {
      return mChildShapes;
   }
