#include "CharacterPhysicsDescriptor.h"

#include <BulletPhys/BulletCollision/CollisionShapes/btMultiSphereShape.h>
#include <BulletPhys/BulletDynamics/Dynamics/btRigidBody.h>
#include <BulletPhys/BulletCollision/CollisionDispatch/btCollisionWorld.h>
#include <BulletPhys/LinearMath/btDefaultMotionState.h>

namespace Game
{

   CharacterPhysicsDescriptor::CharacterPhysicsDescriptor()
      : PhysicsDescriptor(nullptr)
   {
      m_rayLambda[0] = 1.0;
      m_rayLambda[1] = 1.0;
      m_halfHeight = 1.0;
   ...
   void CharacterPhysicsDescriptor::setup(btScalar height, btScalar width, btScalar stepHeight)
   {
   ...
   void CharacterPhysicsDescriptor::destroy()
   {
      if (m_shape)
      {
         delete m_shape;
   ...
   btCollisionObject* CharacterPhysicsDescriptor::getCollisionObject()
   {
      return m_rigidBody;
   }
   ...
   bool CharacterPhysicsDescriptor::canJump() const
   {
      return onGround();
   }
   ...
   bool CharacterPhysicsDescriptor::onGround() const
   {
   ...
   void CharacterPhysicsDescriptor::registerPairCacheAndDispatcher(btOverlappingPairCache* pairCache, btCollisionDispatcher* dispatcher)
   {
