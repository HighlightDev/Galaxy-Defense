...
function LevelFailedOverlay:new(host)
    ...
    local exitToMainMenuButton = LabelButton:new(host, levelFailedOverlay, "Lora-VariableFont_wght", "ExitToMainMenuButton")
    ...
    levelFailedOverlay:subscribeOnAllWidgetLuaProxiesReady(function(host, sender)
        ...
        descriptionLabel:setAnchor(UiItemBase.UiAnchorType.LEFT, UiItemBase.UiAnchorType.LEFT, backgroundRect.widgetName,
        ...
        descriptionLabel:setFontSize(15.0)
        ...
        restartButton:setAnchor(UiItemBase.UiAnchorType.TOP, UiItemBase.UiAnchorType.BOTTOM, descriptionLabel.widgetName,
        ...
        restartButton:setLabelFontSize(56)
