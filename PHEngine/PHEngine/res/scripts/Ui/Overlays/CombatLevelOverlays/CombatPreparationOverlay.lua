...
function CombatPreparationOverlay:new(host)
    ...
    local combatPreparationOverlayCanvas =
        UiCanvas:new(host, 0, 0, windowWidth, windowHeight,
                     "CombatPreparationOverlayCanvas")
    combatPreparationOverlayCanvas:subscribeOnLuaProxyReady(function(host)
        _InitializeCanvasInputSystem(host,
                                     combatPreparationOverlayCanvas.luaProxyId)
    end)
    local combatPreparationOverlay = UiOverlay:createOverlay(host,
                                                             "CombatPreparationOverlay",
                                                             combatPreparationOverlayCanvas)

    combatPreparationOverlay.localTimerManager =
        combatPreparationOverlay:getTimerManager()
    ...
    local createObjectButton = ImageButton:new(host, combatPreparationOverlay,
                                               "CreateObjectButton")
    combatPreparationOverlay:addCompoundWidget(createObjectButton)

    local removeObjectButton = ImageButton:new(host, combatPreparationOverlay,
                                               "RemoveObjectButton")
    ...
    local discardRemoveTowerButton = ImageButton:new(host,
                                                     combatPreparationOverlay,
    ...
    for i = MissileType.BOMB, MissileType.BLACK_HOLE do
        local button = ImageButton:new(host, combatPreparationOverlay,
    ...
    local discardCreateTowerButton = ImageButton:new(host,
                                                     combatPreparationOverlay,
                                                     "DiscardCreateTowerButton")
    combatPreparationOverlay:addCompoundWidget(discardCreateTowerButton)

    local completeStageButton = ImageButton:new(host, combatPreparationOverlay,
                                                "CompleteStageButton")
    ...
    completeStageButton:subscribeOnMouseInputCursorHoverStateChangedCallback(
        function(newState)
            if canCompletePreparationStage then
                if newState == UiItemBase.UiMouseInputCursorHoverState.ENTERED then
                    completeStageButton:setButtonColorHexValue(Styles.Colors
                                                                   .hoveredButtonColor)
                else
                    completeStageButton:setButtonColorHexValue(Styles.Colors
                                                                   .buttonColor)
    ...
    combatPreparationOverlay:subscribeOnAllWidgetLuaProxiesReady(function(host,
                                                                          sender)
        print("combatPreparationOverlay:OnAllWidgetLuaProxiesReady: name: " ..
                  tostring(sender.overlayName))

        backgroundRect:setParent(host,
        ...
        createObjectButton:setParent(host,
                                     combatPreparationOverlayCanvas.widgetName,
        ...
        discardCreateTowerButton:setParent(host,
                                           combatPreparationOverlayCanvas.widgetName,
                                           createMenuDropDownGridLayout.widgetName)
        ...
        completeStageButton:setParent(host,
                                      combatPreparationOverlayCanvas.widgetName,
                                      combatPreparationOverlayCanvas.widgetName)
        completeStageButton:setAnchor(UiItemBase.UiAnchorType.TOP,
                                      UiItemBase.UiAnchorType.TOP,
                                      combatPreparationOverlayCanvas.widgetName,
                                      20)
        completeStageButton:setAnchor(UiItemBase.UiAnchorType.LEFT,
                                      UiItemBase.UiAnchorType.LEFT,
                                      combatPreparationOverlayCanvas.widgetName,
                                      20)
        completeStageButton:setWidth(mainButtonSize)
        completeStageButton:setHeight(mainButtonSize)
        completeStageButton:setButtonBorderRadius(
            CombatPreparationOverlay.buttonRadius)
        ...
        removeObjectButton:setParent(host,
                                     combatPreparationOverlayCanvas.widgetName,
                                     combatPreparationRowLayout.widgetName)
        ...
        removeDropDownPanel:setParent(host,
                                      combatPreparationOverlayCanvas.widgetName,
                                      backgroundRect.widgetName)
        ...
        discardRemoveTowerButton:setParent(host,
                                           combatPreparationOverlayCanvas.widgetName,
    ...
    combatPreparationOverlay.onGameEventTriggered =
    ...
    combatPreparationOverlay.onEngineEventTriggered = function(eventName,
                                                               jsonArgs) end
