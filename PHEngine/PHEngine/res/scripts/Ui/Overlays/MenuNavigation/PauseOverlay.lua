...
function PauseOverlay:new(host)
    ...
    continueButton:subscriveOnMouseInputClickedCallback(function()
    ...
    settingsButton:subscriveOnMouseInputClickedCallback(function()
    ...
    exitToMainMenuButton:subscriveOnMouseInputClickedCallback(function()
