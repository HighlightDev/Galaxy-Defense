...
function SettingsOverlay:new(host)
    ...
    applyButton:subscribeOnMouseInputClickedCallback(function() UiOverlayManager:closeCurrentOverlay(host) end)
    ...
    cancelButton:subscribeOnMouseInputClickedCallback(function() UiOverlayManager:closeCurrentOverlay(host) end)
