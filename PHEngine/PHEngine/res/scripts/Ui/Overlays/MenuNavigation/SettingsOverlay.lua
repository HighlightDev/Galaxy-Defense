...
function SettingsOverlay:new(host)
    ...
    local soundLabel = UiLabel:new(host, "13_5Atom_Sans_Regular")
    pauseSettingsOverlay:addWidget(soundLabel)

    local musicLabel = UiLabel:new(host, "13_5Atom_Sans_Regular")
    ...
    local applyButton = LabelButton:new(host, pauseSettingsOverlay, "13_5Atom_Sans_Regular", "ApplyButton")
    ...
    local cancelButton = LabelButton:new(host, pauseSettingsOverlay, "13_5Atom_Sans_Regular", "CancelButton")
