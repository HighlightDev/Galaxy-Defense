...
MainMenuOverlay = {buttonRadius = 6}

function MainMenuOverlay:new(host)
    local windowWidth = _GetWindowWidth(host)
    local windowHeight = _GetWindowHeight(host)

    local mainMenuOverlayCanvas = UiCanvas:new(host, 0, 0, windowWidth,
                                               windowHeight, "MainMenuCanvas")
    mainMenuOverlayCanvas:subscribeOnLuaProxyReady(function(host)
        ...
        mainMenuOverlayCanvas:addFadeInAnimation(host,
                                                 UiBaseWidget.AnimationInterpolationFunctionType
                                                     .LINEAR, 0.3, "Opacity",
                                                 UiBaseWidget.EnginePropertyType
                                                     .Float, 0.0, 1.0)
        mainMenuOverlayCanvas:addFadeOutAnimation(host,
                                                  UiBaseWidget.AnimationInterpolationFunctionType
                                                      .LINEAR, 0.3, "Opacity",
                                                  UiBaseWidget.EnginePropertyType
                                                      .Float, 1.0, 0.0)
    end)
    local mainMenuOverlay = UiOverlay:createOverlay(host, "MainMenuOverlay",
                                                    mainMenuOverlayCanvas)
    ...
    local totalButtonMarginHeight = buttonsMarginCount *
                                        buttonVerticalMarginHeight;
    buttonHeight = (mainMenuOverlayHeight - totalButtonMarginHeight) /
                       buttonsCount;

    local newGameButton = LabelButton:new(host, mainMenuOverlay,
                                          "Lora-VariableFont_wght",
                                          "NewGameButton")
    mainMenuOverlay:addCompoundWidget(newGameButton)
    newGameButton:subscribeOnMouseInputCursorHoverStateChangedCallback(function(
        newState)
        if newState == UiItemBase.UiMouseInputCursorHoverState.ENTERED then
            newGameButton:setButtonColorHexValue(Styles.Colors
                                                     .hoveredButtonColor)
        else
    ...
    local editorLvlButton = LabelButton:new(host, mainMenuOverlay,
                                            "Lora-VariableFont_wght",
                                            "EditorLvlButton")
    mainMenuOverlay:addCompoundWidget(editorLvlButton)
    editorLvlButton:subscribeOnMouseInputCursorHoverStateChangedCallback(
        function(newState)
            if newState == UiItemBase.UiMouseInputCursorHoverState.ENTERED then
                editorLvlButton:setButtonColorHexValue(Styles.Colors
                                                           .hoveredButtonColor)
            else
    ...
    local settingsButton = LabelButton:new(host, mainMenuOverlay,
                                           "Lora-VariableFont_wght",
                                           "SettingsButton")
    mainMenuOverlay:addCompoundWidget(settingsButton)
    settingsButton:subscribeOnMouseInputCursorHoverStateChangedCallback(
        function(newState)
            if newState == UiItemBase.UiMouseInputCursorHoverState.ENTERED then
                settingsButton:setButtonColorHexValue(Styles.Colors
                                                          .hoveredButtonColor)
            else
    ...
    local exitGameButton = LabelButton:new(host, mainMenuOverlay,
                                           "Lora-VariableFont_wght",
                                           "ExitGameButton")
    mainMenuOverlay:addCompoundWidget(exitGameButton)
    exitGameButton:subscribeOnMouseInputClickedCallback(function()
        EventsHelper:sendExitGameThreadEvent(host, EventsHelper.enqueueJobPolicy
                                                 .IF_DUPLICATE_NO_PUSH)
    end)
    exitGameButton:subscribeOnMouseInputCursorHoverStateChangedCallback(
        function(newState)
            if newState == UiItemBase.UiMouseInputCursorHoverState.ENTERED then
                exitGameButton:setButtonColorHexValue(Styles.Colors
                                                          .hoveredButtonColor)
            else
    ...
    mainMenuOverlay:subscribeOnAllWidgetLuaProxiesReady(
        function(host, sender)
            print("mainMenuOverlay:OnAllWidgetLuaProxiesReady: name: " ..
                      tostring(sender.overlayName))

            backgroundRect:setParent(host, mainMenuOverlayCanvas.widgetName,
                                     mainMenuOverlayCanvas.widgetName)
            ...
            newGameButton:setParent(host, mainMenuOverlayCanvas.widgetName,
                                    backgroundRect.widgetName)
            newGameButton:setAnchor(UiItemBase.UiAnchorType.LEFT,
                                    UiItemBase.UiAnchorType.LEFT,
                                    backgroundRect.widgetName, 20)
            newGameButton:setAnchor(UiItemBase.UiAnchorType.RIGHT,
                                    UiItemBase.UiAnchorType.RIGHT,
                                    backgroundRect.widgetName, 20)
            newGameButton:setAnchor(UiItemBase.UiAnchorType.TOP,
                                    UiItemBase.UiAnchorType.TOP,
                                    backgroundRect.widgetName,
                                    buttonVerticalMarginHeight)
            ...
            newGameButton:setLabelTextHorizontalAlignment(
                UiLabel.TextHorizontalAlignmentType.CENTER)
            newGameButton:setLabelTextVerticalAlignment(
                UiLabel.TextVerticalAlignmentType.CENTER)

            editorLvlButton:setParent(host, mainMenuOverlayCanvas.widgetName,
                                      backgroundRect.widgetName)
            editorLvlButton:setAnchor(UiItemBase.UiAnchorType.LEFT,
                                      UiItemBase.UiAnchorType.LEFT,
                                      backgroundRect.widgetName, 20)
            editorLvlButton:setAnchor(UiItemBase.UiAnchorType.RIGHT,
                                      UiItemBase.UiAnchorType.RIGHT,
                                      backgroundRect.widgetName, 20)
            editorLvlButton:setAnchor(UiItemBase.UiAnchorType.TOP,
                                      UiItemBase.UiAnchorType.BOTTOM,
            ...
            editorLvlButton:setLabelTextHorizontalAlignment(
                UiLabel.TextHorizontalAlignmentType.CENTER)
            editorLvlButton:setLabelTextVerticalAlignment(
                UiLabel.TextVerticalAlignmentType.CENTER)

            settingsButton:setParent(host, mainMenuOverlayCanvas.widgetName,
                                     backgroundRect.widgetName)
            settingsButton:setAnchor(UiItemBase.UiAnchorType.LEFT,
                                     UiItemBase.UiAnchorType.LEFT,
                                     backgroundRect.widgetName, 20)
            settingsButton:setAnchor(UiItemBase.UiAnchorType.RIGHT,
                                     UiItemBase.UiAnchorType.RIGHT,
                                     backgroundRect.widgetName, 20)
            settingsButton:setAnchor(UiItemBase.UiAnchorType.TOP,
                                     UiItemBase.UiAnchorType.BOTTOM,
            ...
            settingsButton:setLabelTextHorizontalAlignment(
                UiLabel.TextHorizontalAlignmentType.CENTER)
            settingsButton:setLabelTextVerticalAlignment(
                UiLabel.TextVerticalAlignmentType.CENTER)

            exitGameButton:setParent(host, mainMenuOverlayCanvas.widgetName,
                                     backgroundRect.widgetName)
            exitGameButton:setAnchor(UiItemBase.UiAnchorType.LEFT,
                                     UiItemBase.UiAnchorType.LEFT,
                                     backgroundRect.widgetName, 20)
            exitGameButton:setAnchor(UiItemBase.UiAnchorType.RIGHT,
                                     UiItemBase.UiAnchorType.RIGHT,
                                     backgroundRect.widgetName, 20)
            exitGameButton:setAnchor(UiItemBase.UiAnchorType.TOP,
                                     UiItemBase.UiAnchorType.BOTTOM,
            ...
            exitGameButton:setLabelTextHorizontalAlignment(
                UiLabel.TextHorizontalAlignmentType.CENTER)
            exitGameButton:setLabelTextVerticalAlignment(
                UiLabel.TextVerticalAlignmentType.CENTER)
        end)
