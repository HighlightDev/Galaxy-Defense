...
// Blur vertical Pass
subroutine(postProc) vec4 verticalBlur()
{
...
subroutine(postProc) vec4 horizontalBlur()
{
...
subroutine(postProc) vec4 extractBrightParts()
{
...
subroutine(postProc) vec4 endBloom()
{
