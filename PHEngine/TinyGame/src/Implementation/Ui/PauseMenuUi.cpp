...
PauseMenuUi::PauseMenuUi(
    const std::string& overlayName, const std::weak_ptr<Scene>& sceneWp, const std::weak_ptr<OverlayManager>& overlayManagerWp)
    : mSceneWp(sceneWp)
...
void PauseMenuUi::Initialize()
{
    if (const auto& sceneSp = mSceneWp.lock()) {
        ...
        continueButtonMouseInputReceiver->SetMouseClickedCallback(
            std::bind(&PauseMenuUi::OnContinueButtonClicked, this, std::placeholders::_1, std::placeholders::_2));
        continueButtonMouseInputReceiver->SetMouseHoverEnteredCallback(
            std::bind(&PauseMenuUi::OnButtonHoverEntered, this, std::placeholders::_1, std::placeholders::_2));
        continueButtonMouseInputReceiver->SetMouseHoverLeavedCallback(
            std::bind(&PauseMenuUi::OnButtonHoverLeaved, this, std::placeholders::_1, std::placeholders::_2));

        const auto& settingsButtonMouseInputReceiver = std::make_shared<UiMouseInputReceiverBase>(settingsButton);
        settingsButtonMouseInputReceiver->SetMouseClickedCallback(
            std::bind(&PauseMenuUi::OnSettingsButtonClicked, this, std::placeholders::_1, std::placeholders::_2));
        settingsButtonMouseInputReceiver->SetMouseHoverEnteredCallback(
            std::bind(&PauseMenuUi::OnButtonHoverEntered, this, std::placeholders::_1, std::placeholders::_2));
        settingsButtonMouseInputReceiver->SetMouseHoverLeavedCallback(
            std::bind(&PauseMenuUi::OnButtonHoverLeaved, this, std::placeholders::_1, std::placeholders::_2));

        const auto& exitToMainMenuButtonMouseInputReceiver = std::make_shared<UiMouseInputReceiverBase>(exitToMainMenuButton);
        exitToMainMenuButtonMouseInputReceiver->SetMouseClickedCallback(
            std::bind(&PauseMenuUi::OnExitToMainMenuButtonClicked, this, std::placeholders::_1, std::placeholders::_2));
        exitToMainMenuButtonMouseInputReceiver->SetMouseHoverEnteredCallback(
            std::bind(&PauseMenuUi::OnButtonHoverEntered, this, std::placeholders::_1, std::placeholders::_2));
        exitToMainMenuButtonMouseInputReceiver->SetMouseHoverLeavedCallback(
            std::bind(&PauseMenuUi::OnButtonHoverLeaved, this, std::placeholders::_1, std::placeholders::_2));

        const auto& exitGameButtonMouseInputReceiver = std::make_shared<UiMouseInputReceiverBase>(exitGameButton);
        exitGameButtonMouseInputReceiver->SetMouseClickedCallback(
            std::bind(&PauseMenuUi::OnExitGameButtonClicked, this, std::placeholders::_1, std::placeholders::_2));
        exitGameButtonMouseInputReceiver->SetMouseHoverEnteredCallback(
            std::bind(&PauseMenuUi::OnButtonHoverEntered, this, std::placeholders::_1, std::placeholders::_2));
        exitGameButtonMouseInputReceiver->SetMouseHoverLeavedCallback(
            std::bind(&PauseMenuUi::OnButtonHoverLeaved, this, std::placeholders::_1, std::placeholders::_2));
