...
PauseSettingsMenuUi::PauseSettingsMenuUi(
...
void PauseSettingsMenuUi::Initialize()
{
    if (const auto& sceneSp = mSceneWp.lock()) {
        ...
        backgroundRect->SetParents(mPauseSettingsMenuCanvas, mPauseSettingsMenuCanvas);
        ...
        const auto& soundToggleButton = std::make_shared<UiToggleButton>(false);
        soundToggleButton->SetParents(mPauseSettingsMenuCanvas, backgroundRect);
        ...
        applyButtonMouseInputReceiver->SetMouseClickedCallback(
            std::bind(&PauseSettingsMenuUi::OnApplyButtonClicked, this, std::placeholders::_1, std::placeholders::_2));
        applyButtonMouseInputReceiver->SetMouseHoverEnteredCallback(
            std::bind(&PauseSettingsMenuUi::OnButtonHoverEntered, this, std::placeholders::_1, std::placeholders::_2));
        applyButtonMouseInputReceiver->SetMouseHoverLeavedCallback(
            std::bind(&PauseSettingsMenuUi::OnButtonHoverLeaved, this, std::placeholders::_1, std::placeholders::_2));

        const auto& cancelButtonMouseInputReceiver = std::make_shared<UiMouseInputReceiverBase>(cancelButton);
        cancelButtonMouseInputReceiver->SetMouseClickedCallback(
            std::bind(&PauseSettingsMenuUi::OnCancelButtonClicked, this, std::placeholders::_1, std::placeholders::_2));
        cancelButtonMouseInputReceiver->SetMouseHoverEnteredCallback(
            std::bind(&PauseSettingsMenuUi::OnButtonHoverEntered, this, std::placeholders::_1, std::placeholders::_2));
        cancelButtonMouseInputReceiver->SetMouseHoverLeavedCallback(
            std::bind(&PauseSettingsMenuUi::OnButtonHoverLeaved, this, std::placeholders::_1, std::placeholders::_2));

        const auto& soundToggleButtonMouseInputReceiver = std::make_shared<UiMouseInputReceiverToggleButton>(soundToggleButton);
        soundToggleButtonMouseInputReceiver->SetButtonToggledCallback(
            std::bind(&PauseSettingsMenuUi::OnSoundButtonToggled, this, std::placeholders::_1, std::placeholders::_2));
